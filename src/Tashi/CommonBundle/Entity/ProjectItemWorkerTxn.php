...
/**
 * ProjectItemWorkerTxn
 *
 * @ORM\Table(name="project_item_worker_txn", indexes={@ORM\Index(name="fk_projectitem_itemworker_idx", columns={"Project_item_id_fk"}), @ORM\Index(name="fk_workder_itemworkder_idx", columns={"Worker_id_fk"})})
 * @ORM\Entity
 */
class ProjectItemWorkerTxn
{
    /**
     * @var integer
     *
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="Worker_id_fk", referencedColumnName="Employee_Pk")
     * })
     */
    private $workerFk;
     ...
     * Set workerFk
     *
     * @param \Tashi\CommonBundle\Entity\EmpEmployeeMaster $workerFk
     *
     * @return ProjectItemWorkerTxn
     */
    public function setWorkerFk(\Tashi\CommonBundle\Entity\EmpEmployeeMaster $workerFk = null)
    {
