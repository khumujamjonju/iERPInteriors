 ...
 * EmpAddressTxn
 *
 * @ORM\Table(name="emp_address_txn", indexes={@ORM\Index(name="fk_emp_master_idx", columns={"Emp_Master_Fk"}), @ORM\Index(name="fk_worker_expert_idx", columns={"Address_Master_Fk"})})
 * @ORM\Entity
 */
class EmpAddressTxn
{
     ...
     * @var integer
     *
     * @ORM\Column(name="Emp_Address_Pk", type="integer")
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $empAddressPk;
     ...
     * @return integer
     */
    public function getEmpAddressPk()
    {
        return $this->empAddressPk;
    }
