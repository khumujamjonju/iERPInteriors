 ...
 * ProjectDocumentTxn
 *
 * @ORM\Table(name="project_document_txn", indexes={@ORM\Index(name="fk_project_projdoctxn_idx", columns={"Project_id_fk"}), @ORM\Index(name="fk_document_projdoctxn_idx", columns={"Document_id_fk"})})
 * @ORM\Entity
 */
class ProjectDocumentTxn
{
    /**
     * @var integer
     *
