...
/**
 * PrdProductUnitMaster
 *
 * @ORM\Table(name="prd_product_unit_master")
 * @ORM\Entity
 */
class PrdProductUnitMaster
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="unit_description", type="string", length=500, nullable=true)
     */
