...
/**
 * EmpAccountSourcetype
 *
 * @ORM\Table(name="emp_account_sourcetype")
 * @ORM\Entity
 */
class EmpAccountSourcetype
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="is_related", type="integer", nullable=true)
     */
    private $isRelated;
