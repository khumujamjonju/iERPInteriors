...
/**
 * CmnPersonReligionMaster
 *
 * @ORM\Table(name="cmn_person_religion_master")
 * @ORM\Entity
 */
class CmnPersonReligionMaster
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="Religion_Name", type="string", length=265, nullable=true)
     */
     ...
     *
     * @return CmnPersonReligionMaster
     */
