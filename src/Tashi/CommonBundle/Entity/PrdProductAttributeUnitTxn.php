...
/**
 * PrdProductAttributeUnitTxn
 *
 * @ORM\Table(name="prd_product_attribute_unit_txn", indexes={@ORM\Index(name="fk_unit_master_txn_idx", columns={"unit_master_id"}), @ORM\Index(name="fk_attrib_master_txn_idx", columns={"attribute_master_id"})})
 * @ORM\Entity
 */
class PrdProductAttributeUnitTxn
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="unit_master_id", type="integer", nullable=true)
     */
    private $unitMasterId;
     ...
     * Set unitMasterId
     *
     * @param integer $unitMasterId
     *
     * @return PrdProductAttributeUnitTxn
     */
    public function setUnitMasterId($unitMasterId)
    {
