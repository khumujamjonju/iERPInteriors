...
/**
 * ProjectItemStatusTxn
 *
 * @ORM\Table(name="project_item_status_txn", indexes={@ORM\Index(name="fk_item_itemstatus_idx", columns={"Item_id_fk"}), @ORM\Index(name="fk_status_itemstatus_idx", columns={"Status_fk"})})
 * @ORM\Entity
 */
class ProjectItemStatusTxn
{
    /**
     * @var integer
     *
