 ...
 * AccountSourceType
 *
 * @ORM\Table(name="account_source_type")
 * @ORM\Entity
 */
class AccountSourceType
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="source_type", type="string", length=45, nullable=true)
     */
    private $sourceType;
     ...
     * @var string
     *
     * @ORM\Column(name="source_description", type="string", length=45, nullable=true)
     */
