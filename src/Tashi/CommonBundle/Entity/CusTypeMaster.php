 ...
 * CusTypeMaster
 *
 * @ORM\Table(name="cus_type_master")
 * @ORM\Entity
 */
class CusTypeMaster
{
     ...
     * @var integer
     *
     * @ORM\Column(name="Customer_Type_Pk", type="integer")
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $customerTypePk;

    /**
     * @var string
     *
     * @ORM\Column(name="Customer_Type_Code", type="string", length=5, nullable=true)
     */
    private $customerTypeCode;

    /**
     * @var string
     *
     * @ORM\Column(name="Customer_Type_Name", type="string", length=100, nullable=true)
     */
     ...
     * @return integer
     */
    public function getCustomerTypePk()
    {
        return $this->customerTypePk;
    }
     ...
     *
     * @return CusTypeMaster
     */
    public function setCustomerTypeCode($customerTypeCode)
    {
