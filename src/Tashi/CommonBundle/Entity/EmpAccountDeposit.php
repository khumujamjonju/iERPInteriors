 ...
 * EmpAccountDeposit
 *
 * @ORM\Table(name="emp_account_deposit", indexes={@ORM\Index(name="fk_account_id_idx", columns={"Accnt_id_fk"}), @ORM\Index(name="fk_emp_deposit_idx", columns={"Emp_id_fk"}), @ORM\Index(name="fk_source_deposite_idx", columns={"source_type"})})
 * @ORM\Entity(repositoryClass="Tashi\CommonBundle\Repository\WalletRepository")
 */
class EmpAccountDeposit
{
    /**
     * @var integer
     *
    ...
    /**
     * @var \Tashi\CommonBundle\Entity\EmpAccountSourceMaster
     *
     * @ORM\ManyToOne(targetEntity="Tashi\CommonBundle\Entity\EmpAccountSourceMaster")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="source_type", referencedColumnName="Pkid")
     * })
     */
    private $sourceType;
     ...
     * Set sourceType
     *
     * @param \Tashi\CommonBundle\Entity\EmpAccountSourceMaster $sourceType
     *
     * @return EmpAccountDeposit
     */
    public function setSourceType(\Tashi\CommonBundle\Entity\EmpAccountSourceMaster $sourceType = null)
    {
     ...
     * Get sourceType
     *
     * @return \Tashi\CommonBundle\Entity\EmpAccountSourceMaster
     */
