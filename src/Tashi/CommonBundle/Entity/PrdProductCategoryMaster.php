...
/**
 * PrdProductCategoryMaster
 *
 * @ORM\Table(name="prd_product_category_master")
 * @ORM\Entity
 */
class PrdProductCategoryMaster
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="Category_id", type="string", length=45, nullable=true)
     */
    private $categoryId;
     ...
     * @var string
     *
     * @ORM\Column(name="Category_Name", type="string", length=125, nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="Category_Desc", type="string", length=250, nullable=true)
     */
     ...
     *
     * @return PrdProductCategoryMaster
     */
