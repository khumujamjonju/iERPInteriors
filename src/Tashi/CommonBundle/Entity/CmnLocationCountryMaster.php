...
/**
 * CmnLocationCountryMaster
 *
 * @ORM\Table(name="cmn_location_country_master")
 * @ORM\Entity
 */
class CmnLocationCountryMaster
{
    /**
     * @var integer
     *
     * @ORM\Column(name="Country_Pk", type="integer")
     * @ORM\Id
     ...
     *
     * @return CmnLocationCountryMaster
     */
