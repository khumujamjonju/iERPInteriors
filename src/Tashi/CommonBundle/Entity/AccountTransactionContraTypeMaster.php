...
/**
 * AccountTransactionContraTypeMaster
 *
 * @ORM\Table(name="account_transaction_contra_type_master")
 * @ORM\Entity
 */
class AccountTransactionContraTypeMaster
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="source_description", type="string", length=400, nullable=true)
     */
     ...
     *
     * @return AccountTransactionContraTypeMaster
     */
