 ...
 * TransporterMaster
 *
 * @ORM\Table(name="transporter_master")
 * @ORM\Entity
 */
class TransporterMaster
{
     ...
     * @var string
     *
     * @ORM\Column(name="Contact_Person", type="string", length=200, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="Pincode", type="string", length=8, nullable=true)
     */
    private $pincode;
