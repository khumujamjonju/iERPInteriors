 ...
 * BranchAddressTxn
 *
 * @ORM\Table(name="branch_address_txn", indexes={@ORM\Index(name="fk_address_branchaddresstxn_idx", columns={"Address_Id_Fk"}), @ORM\Index(name="fk_branch_braddresstxn_idx", columns={"Branch_id_fk"})})
 * @ORM\Entity
 */
class BranchAddressTxn
{
    /**
     * @var integer
     *
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="Branch_id_fk", referencedColumnName="Pkid")
     * })
     */
    private $branchFk;
     ...
     * Set branchFk
     *
     * @param \Tashi\CommonBundle\Entity\BranchMaster $branchFk
     *
     * @return BranchAddressTxn
     */
    public function setBranchFk(\Tashi\CommonBundle\Entity\BranchMaster $branchFk = null)
    {
